...
//funcion anonima sin nombre, se asigna a una varible que si tiene nombre
/*
function esmayorEdad(persona){
  //retorna true o false dependiendo si se cumple o no la condicion
  return persona.edad >= MAYORIA_DE_EDAD
}
*/
//arrow function
//retorna true o false dependiendo si se cumple o no la comparacion
//Si solo retorna se puede quitar la palabra return
//le pasamos un objeto que tiene un key edad
